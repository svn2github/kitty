/*
-- putty-0.59/windows/cthelper/buffer.c	1969-12-31 17:00:00.000000000 -0700
++ putty-0.59-cygterm/windows/cthelper/buffer.c	2005-12-14 12:30:35.000000000 -0700
@ -0,0 +1,76 @@
*/
#include <stdlib.h>
#include <string.h>
...
buffer_read(Buffer b, int d)
{
	...
	while (b->avail > 0 && (n = read(d, &b->data[b->len], b->avail)) > 0) {
...
buffer_write(Buffer b, int d)
{
	...
	while (b->len > 0 && (n = write(d, b->data, b->len)) > 0) {
